  ...
  return (
    <div className="cookie-banner" role="dialog" aria-live="polite" aria-label="Cookie notice">
      <div className="cookie-content">
        <p>
          Artist Insight uses essential cookies so you can stay signed in securely and keep your session protected. No
          advertising or analytics cookies are used. Learn more in our{' '}
